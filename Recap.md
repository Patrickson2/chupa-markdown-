## Quering database in a flask application
Querying a Database in a Flask Application : Code-Along (CodeGrade)
...
error message for pet with id 1000
...
if __name__ == '__main__':
    app.run(port=5555, debug=True)
Resources
Quickstart - Flask-SQLAlchemyLinks to an external site.
Flask-MigrateLinks to an external site.
Flask Extensions, Plug-ins, and Related Libraries - Full Stack PythonLinks to an external site.
